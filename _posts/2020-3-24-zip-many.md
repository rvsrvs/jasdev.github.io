...
[I landed](https://github.com/CombineCommunity/CombineExt/pull/6) these overloads to a community collection of Combine extensions, `CombineExt`. So, it’s a CocoaPod-, Carthage-, or SPM-installation away.
